...
</head><body bgcolor="#006400">
<center><b><font color = "brown" size="6">eVoting</font></b></center><br><br>
<div id="page">
<div id="header">
<h1>POLL RESULTS </h1>
...
<img src="images/candidate-2.gif"
width='<?php if(isset($_POST['Submit'])){ if ($candidate_2 || $candidate_1 != 0){echo(100*round($candidate_3/($candidate_2+$candidate_1),2));}} ?>'
height='20'>
<?php if(isset($_POST['Submit'])){ if ($candidate_3 ||$candidate_2 || $candidate_1 != 0){echo(100*round($candidate_3/($candidate_2+$candidate_1),2));}} ?>% of <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> total votes
